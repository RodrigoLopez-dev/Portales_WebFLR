  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content" style="width:400px;">
      ...
      <div class="modal-body" style="text-align: center;">
        ...
        <p>
          <br>Número cuenta corriente: 4000 10 41
          <br>Banco: BCI
          <br>Titular: Fundación Las Rosas
          <br>Rut: 70.543.600-2
          <br>Email: emergenciahogares@flrosas.cl
        </p>
        <br><br>
        <script>
        ...
        <datos contenteditable="true" hidden>Fundacion Las Rosas<br>70.543.600-2<br>BCI<br>Cuenta
          Corriente<br>40001041<br>emergenciahogares@flrosas.cl</datos>
