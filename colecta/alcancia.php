...
<head>
    ...
    <meta property="og:image" content="https://www.fundacionlasrosas.cl/colecta/imagen/colecta25.jpg" />
    <meta property="og:image:secure_url" content="https://www.fundacionlasrosas.cl/colecta/imagen/colecta25.jpg" />
                        ...
                        <div class="banner_text_iner">
                            <div style="max-width:400px; margin-left:auto;margin-right:auto;">
                                <table width="100%" border="0">
                                    <tr>
                                        <td rowspan="2">
                                            <a href="https://api.whatsapp.com/send?text=Te%20invito%20a%20ayudar%20a%20más%20de%202.200%20adultos%20mayores%20👴🏻👵🏻%20en%20*La%20Colecta%20de%20Fundación%20Las%20Rosas*%20apóyanos%20donando%20en%20el%20siguiente%20link:%20%20https%3A//fundacionlasrosas.cl/colecta/alcancia?c=<?php echo $codigo; ?> "
                                                style="color:white;font-size: 10px;">
                                                <img src='images/iconos/whatsapp-circle.png' style="width:40px;">
                                                Compartir alcancía
                                            </a>
                                        </td>
                                        <td valign="center"><br>
                                    ...
                                    <tr>
                                        <td valign="top">
                                            <h4 style="color:white;font-size: 15px;">Total recaudado :
                    ...
                    <div class="single_event">
                        <div class="banner_text text-center">
                            <form id="formDonacion" name="formDonacion" method="post">
                                ...
                                <section class="donation-options">
                                    <div class="donation-option">
                                        <input type="radio" id="control_01" name="select"
                                            value="<?php echo $amount1; ?>" onclick="f_check()">
                                    ...
                                    <div class="donation-option">
                                        <input type="radio" id="control_02" name="select"
                                            value="<?php echo $amount2; ?>" onclick="f_check()">
                                    ...
                                    <div class="donation-option">
                                        <input type="radio" id="control_03" name="select"
                                            value="<?php echo $amount3; ?>" onclick="f_check()">
                                    ...
                                    <div class="donation-option">
                                        <input type="radio" id="control_04" name="select"
                                            value="<?php echo $amount4; ?>" onclick="f_check()">
                                    ...
                                    <div class="donation-option">
                                        ...
                                        <label for="control_05"
                                            class="donation-card donation-card-wide donation-card-other">
                                            <span class="donation-other-title">Otro Monto</span>
                                            <input type="text" value="" class="form-control" id="txt_otro"
                                                name="txt_otro">
                                        </label>
                                    </div>
                                </section>
                                ...
                                <br>
                                <h4 style="color:white;">Metodos de donación :</h4>
                                ...
                                <section>
                                    ...
                                    <input id="ip_transaccion" name="ip_transaccion" type="text"
                                        value="<?php echo $miip ?>" hidden>
                                    <input id="ip_ciudad" name="ip_ciudad" type="text" value="<?php echo $ip_ciudad ?>"
                                        hidden>
                                    <input id="ip_region" name="ip_region" type="text" value="<?php echo $ip_region ?>"
                                        hidden>
                                    <input id="ip_pais" name="ip_pais" type="text" value="<?php echo $ip_pais ?>"
                                        hidden>
                                    <input id="ip_latitud" name="ip_latitud" type="text"
                                        value="<?php echo $ip_latitud ?>" hidden>
                                    <input id="ip_longitud" name="ip_longitud" type="text"
                                        value="<?php echo $ip_longitud ?>" hidden>
                                    <input id="utm_source" name="utm_source" type="text"
                                        value="<?php echo $utm_source ?>" hidden>
                                    <input id="utm_medium" name="utm_medium" type="text"
                                        value="<?php echo $utm_medium ?>" hidden>
