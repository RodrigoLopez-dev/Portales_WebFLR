    ...
    <section class="landing-content">
        ...
        <div class="landing-right">
            <div class="hero-message">
                <p class="hero-text">
                    Tu donación es muy importante para que podamos seguir cuidando con cariño a las 2.300 personas
                    mayores que acogemos en nuestros 28 hogares a lo largo de Chile.
                </p>
            </div>
            ...
            <div class="donation-grid">
                ...
                <div class="donation-row donation-row-top">
                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-1" value="15000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$15.000</span>
                        </button>
                    </div>

                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-2" value="30000"
                            onclick="scrollToElement('metodoPago')">
                    ...
                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-3" value="45000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$45.000</span>
                        </button>
                    </div>
                </div>
                ...
                <div class="donation-row donation-row-bottom">
                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-4" value="60000"
                            onclick="scrollToElement('metodoPago')">
