...
function ObtieneListaDespacho(pago_id){
var p = {};
p["pago_id"] = pago_id;

$.ajax({
    url: "crud/traeListaDespacho.php",
    type: "GET",
    async:true,
    data:p,
    dataType: "json"
 ...
 .done(function( data, textStatus, jqXHR ) {
   ...
   var cabeza = '<table id="tabla_despacho" class="table table-striped table-bordered" style="width:100%">'+
      '<thead>'+
       '<tr>'+
       '<th>Pedido</th>'+
       '<th>Fecha</th>'+
