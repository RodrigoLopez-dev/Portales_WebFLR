...
<body id="fondo-invierno">
    ...
    <div class="container">
        <div class="row">
            ...
            <img src="imagenes/fondo/fondo_lnding.png" alt="Imagen" id="img-left">
            </div>-->
            <!-- Imagen para móviles -->
            <div class="col-md-6 d-block d-md-none" style="text-align: center;">
                ...
                <br>
                <br>
                <img src="imagenes/fondo/caja_mobile.png" alt="Imagen" id="img-left"
                    style="opacity: 0.9; filter: drop-shadow(3px 3px 8px rgba(0,0,0,0.7));">
                <br>
                <!--img src="imagenes/fondo/contenido_caja.png" alt="Imagen" id="img-left"
     style="opacity: 0.9; filter: drop-shadow(3px 3px 8px rgba(0,0,0,0.7));">-->
                <br>
                <br>
                <p class="titulos-inicio text-center  text-md-start"><br><br> <b>Selecciona tu aporte:
                    </b></p>
                <div class="row">
                    <!--<div class="col-sm-4">-->
                    ...
                    <!--</div>-->
                    <div class="col-sm-4 donation-wrapper">
                        <button class="donation" value="30000" onclick="scrollToElement('metodoPagoM')">
                            <img src="imagenes/botones/btn_30.png" alt="$30.000" class="donation-img" width="70%">
                        </button>
                    </div>
                    <!--<div class="col-sm-4">-->
                    ...
                    <!--</div>-->
                    <div class="col-sm-4 donation-wrapper">
                        <button class="donation" value="45000" onclick="scrollToElement('metodoPagoM')">
                            <img src="imagenes/botones/btn_45.png" alt="$45.000" class="donation-img" width="70%">
                        </button>
                    </div>
                    <div class="row">
                        <!--<div class="col-sm-6">-->
    ...
    <div class="container d-none d-md-block pt-4" style="margin-top: -120px;">
        ...
        <div class="col-md-8 offset-md-6 col-12 text-center">
            <br>
            <img src="imagenes/fondo/texto_navidad252.png" alt="Imagen" class="img-fluid" width="100%" heigth="100%"
                margin-top="10%">
            <br> <br>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-5  ">
                                <button class="donation" value="60000" onclick="scrollToElement('metodoPagoE')">
                                    <img src="imagenes/botones/btn_60.png" alt="$60.000" class="donation-img"
                                        width="100%" height="60%">
                                </button>
                            </div>
