    ...
    <section class="landing-content">
        ...
        <div class="landing-right">
            <div class="imagen-container">
                <div class="imagen-text-cont">
                    <img class="texto-grado" src="imagenes/invierno/Aporta.png" alt="Aporta con">
                    <img class="gradoc" src="imagenes/invierno/GradoCalor.png" alt="Grado de Calor">
                </div>
                <div class="imagen-termometro">
                    <img src="imagenes/invierno/Termo0.png" alt="Termometro">
                </div>
                <!-- <img src="imagenes/invierno2026-gradocalor.png" alt="Imagen" id="img-left"> -->
            </div>

            <p class="titulos-inicio">
                Este invierno tu aporte son <b>horas de calor</b> para el bienestar de <b>nuestros 28 hogares.</b>
                Puedes seleccionar tu aporte por residente de:
            </p>
            ...
            <div class="donation-grid">
                ...
                <div class="donation-row donation-row-top">
                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-1" value="20000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$20.000</span>
                        </button>
                        <span>1 semana de calor</span>
                    </div>

                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-2" value="40000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$40.000</span>
                        </button>
                        <span>2 semana de calor</span>
                    </div>
                </div>

                <!-- FILA INTERMEDIA -->
                <div class="donation-row donation-row-mid">
                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-3" value="60000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$60.000</span>
                        </button>
                        <span>3 semana de calor</span>
                    </div>

                    <div class="donation-wrapper">
                        <button type="button" class="donation donation-code donation-4" value="80000"
                            onclick="scrollToElement('metodoPago')">
                            <span class="donation-code-main">$80.000</span>
                        </button>
                        <span>1 mes de calor</span>
                    </div>
                </div>
                    ...
                    <div class="donation-wrapper donation-wrapper-otro">
                        <button type="button" class="donation donation-code donation-otro" value=""
                            ...
                            <span class="donation-code-main donation-code-main-otro">
                                <span class="donation-otro-label">Otro monto</span>
            ...
            <div class="payment-options" id="metodoPago">
                ...
                <div class="payment-button-group">
                    <button type="button" data-payment="2" class="payment-button"
                        style="background-image: url('imagenes/botones/boton_fintoc.png');">
                    </button>
                    ...
                    <button type="button" data-payment="3" class="payment-button"
                        style="background-image: url('imagenes/botones/boton_mach.png');">
                    </button>
                </div>
            </div>
        </div>
